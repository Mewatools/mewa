...
MxVector4UC const imageViewBackground = {102, 102, 102, 255};
...
MxVector4UC const disabledText = { 110,110,110,255 };
...
MxVector4UC const darkRed = {193, 39, 45, 255};
MxVector4UC const brightRed = {237, 28, 36, 255};

MxVector4UC const nodeInnerBody = {122, 122, 122, 255};
